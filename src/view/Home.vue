...
<template>
  <div
    class="relative min-h-[40rem] lg:min-h-0 bg-surface-0 dark:bg-surface-900 flex lg:flex-row flex-col h-[93.3vh]"
  >
    <div
      ...
      <div class="relative flex-1 z-20 flex items-center justify-center">
        <div class="flex items-center justify-center h-full">
          ...
          >
            ...
            >
              <span class="block">Hostel Management System</span>
            </h1>
